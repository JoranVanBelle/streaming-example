...
public class WindSpeedDetectedRekeyProcessor implements Processor<String, WindSpeedDetected, String, WindSpeedDetected> {

    public static final String NAME = WindSpeedDetectedRekeyProcessor.class.getSimpleName();
    private final LocationKeyMapping locationKeyMapping;
    private final Clock clock;
    private ProcessorContext<String, WindSpeedDetected> context;

    public WindSpeedDetectedRekeyProcessor(Clock clock, LocationKeyMapping locationKeyMapping) {
