...
public class WindRekeyProcessor implements Processor<String, SpecificRecord, String, SpecificRecord> {

    public static final String NAME = WindRekeyProcessor.class.getSimpleName();
    private final LocationKeyMapping locationKeyMapping;
    private final Clock clock;
    private ProcessorContext<String, SpecificRecord> context;

    public WindRekeyProcessor(Clock clock, LocationKeyMapping locationKeyMapping) {
